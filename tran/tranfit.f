...
C
     ...
     1           KDIM=2000, NFDIM=165, NO=4, NT=50, NCHECK=1000,
     2           LENICK=500000, LENRCK=2000000, LENCCK=20000, MAXFIT=7,
     3           NRANGE=2, MAXTMP=3, LSYM=16)
C
...
C
      CHARACTER CCKWRK(LENCCK)*(LSYM), KSYM(KDIM)*(LSYM), LINE*80, 
     1          VERS*(LSYM),  PREC*(LSYM)
      LOGICAL IERR, KERR
...
C
      ...
      CALL CKINIT_PLOG (LENICK, LENRCK, LENCCK, LINKCK, LOUT, ICKWRK,
     1             RCKWRK, CCKWRK)
	  IFLAG = 0

C      CALL CKINIT (LENICK, LENRCK, LENCCK, LINKCK, LOUT, ICKWRK,
C     1             RCKWRK, CCKWRK)
C      IFLAG = 0
